        ...
        <div className="flex items-center col-span-2 w-full h-16 bg-slate-900 rounded-md">
            ...
            <div className="grid grid-cols-12 flex-grow px-6 items-center">
                ...
                <div className="col-span-2">
                    ...
                    <span className="text-sm text-gray-400"> {record.amount}</span>
                </div>
                <div className="col-span-2">
                    <span className="text-sm text-blue-300">واحد: </span>
                    <span className="text-sm text-gray-400">{record.unit?.name}</span>
                </div>
                ...
                <div className="text-left col-span-1">
                    <Link href={`/dashboard/transactions/entries/${router.query.entry}/records/${record.id}`} className="text-gray-300 hover:text-indigo-400">مشاهده</Link>
                </div>
            </div>
        </div>
