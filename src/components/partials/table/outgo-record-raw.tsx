...
export default function OutgoRecordRaw({ record, no }: { record: any, no: number }) {
        ...
        <div className="flex items-center col-span-2 w-full h-16 bg-slate-900 rounded-md">
            ...
            <div className="grid grid-cols-12 flex-grow px-6 items-center">
                ...
                <div className="text-left col-span-1">
                    <Link href={`/dashboard/transactions/outgoes/${router.query.outgo}/${record.id}`} className="text-gray-300 hover:text-indigo-400">مشاهده</Link>
                </div>
            </div>
        </div>
